			...
			<div class="about__additional">
				<div class="about__card about__card--position">
					...
					<div class="about__card-item">
						...
						<p class="d-flex align-items-center">Cormack Advertising</p>
					</div>
					<div class="about__card-item">
						<h6>Degree</h6>
						<p class="mb-0">First in Graphic Design</p>
					</div>
				</div>
